...
CMsgTest_MessageToClient_Request = _reflection.GeneratedProtocolMessageType('CMsgTest_MessageToClient_Request',
...
CMsgTest_MessageToClient_Response = _reflection.GeneratedProtocolMessageType('CMsgTest_MessageToClient_Response',
                                                                             (_message.Message,), dict(
...
CMsgTest_NotifyClient_Notification = _reflection.GeneratedProtocolMessageType('CMsgTest_NotifyClient_Notification',
                                                                              (_message.Message,), dict(
...
CMsgTest_MessageToServer_Request = _reflection.GeneratedProtocolMessageType('CMsgTest_MessageToServer_Request',
                                                                            (_message.Message,), dict(
...
CMsgTest_MessageToServer_Response = _reflection.GeneratedProtocolMessageType('CMsgTest_MessageToServer_Response',
                                                                             (_message.Message,), dict(
...
CMsgTest_NotifyServer_Notification = _reflection.GeneratedProtocolMessageType('CMsgTest_NotifyServer_Notification',
                                                                              (_message.Message,), dict(
...
TestServerFromClient_Stub = service_reflection.GeneratedServiceStubType('TestServerFromClient_Stub',
                                                                        (TestServerFromClient,), dict(
        DESCRIPTOR=_TESTSERVERFROMCLIENT,
        __module__='steammessages_unified_test_pb2'
    ))
