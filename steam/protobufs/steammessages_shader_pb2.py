...
CShader_RegisterShader_Request = _reflection.GeneratedProtocolMessageType('CShader_RegisterShader_Request',
...
CShader_RegisterShader_Response = _reflection.GeneratedProtocolMessageType('CShader_RegisterShader_Response',
                                                                           (_message.Message,), dict(
...
CShader_SendShader_Request = _reflection.GeneratedProtocolMessageType('CShader_SendShader_Request', (_message.Message,),
                                                                      dict(
                                                                          ...
                                                                          ShaderCode=_reflection.GeneratedProtocolMessageType(
                                                                              'ShaderCode', (_message.Message,), dict(
...
CShader_SendShader_Response = _reflection.GeneratedProtocolMessageType('CShader_SendShader_Response',
                                                                       (_message.Message,), dict(
...
CShader_GetBucketManifest_Request = _reflection.GeneratedProtocolMessageType('CShader_GetBucketManifest_Request',
                                                                             (_message.Message,), dict(
...
CShader_GetBucketManifest_Response = _reflection.GeneratedProtocolMessageType('CShader_GetBucketManifest_Response',
                                                                              (_message.Message,), dict(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030eClient just finished playing a game, detected new shader cache entries and is notifying us about them'),
        ),
        _descriptor.MethodDescriptor(
            name='SendShader',
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030KClient wants to know the manifest ID to fetch (if any) for a bucket\'s depot'),
        ),
    ])
