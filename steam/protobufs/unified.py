...
UMS: Mapping[str, type[betterproto.Message]] = {
    ...
    "LoyaltyRewards.AddReaction#1_Request": loyalty_rewards.AddReactionRequest,
    "LoyaltyRewards.AddReaction#1_Response": loyalty_rewards.AddReactionResponse,
    "LoyaltyRewards.BatchedQueryRewardItems#1_Request": loyalty_rewards.BatchedQueryRewardItemsRequest,
    "LoyaltyRewards.BatchedQueryRewardItems#1_Response": loyalty_rewards.BatchedQueryRewardItemsResponse,
    "LoyaltyRewards.GetActivePurchaseBonuses#1_Request": loyalty_rewards.GetActivePurchaseBonusesRequest,
    "LoyaltyRewards.GetActivePurchaseBonuses#1_Response": loyalty_rewards.GetActivePurchaseBonusesResponse,
    "LoyaltyRewards.GetEligibleApps#1_Request": loyalty_rewards.GetEligibleAppsRequest,
    "LoyaltyRewards.GetEligibleApps#1_Response": loyalty_rewards.GetEligibleAppsResponse,
    "LoyaltyRewards.GetPointsForSpend#1_Response": loyalty_rewards.GetPointsForSpendResponse,
    "LoyaltyRewards.GetProfileCustomizationsConfig#1_Response": loyalty_rewards.GetProfileCustomizationsConfigResponse,
    "LoyaltyRewards.GetReactionConfig#1_Request": loyalty_rewards.GetReactionConfigRequest,
    "LoyaltyRewards.GetReactionConfig#1_Response": loyalty_rewards.GetReactionConfigResponse,
    "LoyaltyRewards.GetReactions#1_Request": loyalty_rewards.GetReactionsRequest,
    "LoyaltyRewards.GetReactions#1_Response": loyalty_rewards.GetReactionsResponse,
    "LoyaltyRewards.GetReactionsSummaryForUser#1_Response": loyalty_rewards.GetReactionsSummaryForUserResponse,
    "LoyaltyRewards.GetSummary#1_Request": loyalty_rewards.GetSummaryRequest,
    "LoyaltyRewards.GetSummary#1_Response": loyalty_rewards.GetSummaryResponse,
    "LoyaltyRewards.QueryRewardItems#1_Request": loyalty_rewards.QueryRewardItemsRequest,
    "LoyaltyRewards.QueryRewardItems#1_Response": loyalty_rewards.QueryRewardItemsResponse,
    "LoyaltyRewards.RedeemPoints#1_Request": loyalty_rewards.RedeemPointsRequest,
    "LoyaltyRewards.RedeemPoints#1_Response": loyalty_rewards.RedeemPointsResponse,
    "LoyaltyRewards.RedeemPointsForBadgeLevel#1_Request": loyalty_rewards.RedeemPointsForBadgeLevelRequest,
    "LoyaltyRewards.RedeemPointsForBadgeLevel#1_Response": loyalty_rewards.RedeemPointsResponse,
    "LoyaltyRewards.RedeemPointsForProfileCustomization#1_Request": loyalty_rewards.RedeemPointsForProfileCustomizationRequest,
    "LoyaltyRewards.RedeemPointsForProfileCustomization#1_Response": loyalty_rewards.RedeemPointsForProfileCustomizationResponse,
    "LoyaltyRewards.RedeemPointsForProfileCustomizationUpgrade#1_Request": loyalty_rewards.RedeemPointsForProfileCustomizationUpgradeRequest,
    "LoyaltyRewards.RedeemPointsForProfileCustomizationUpgrade#1_Response": loyalty_rewards.RedeemPointsForProfileCustomizationUpgradeResponse,
    "LoyaltyRewards.RedeemPointsToUpgradeItem#1_Request": loyalty_rewards.RedeemPointsRequest,
    "LoyaltyRewards.RedeemPointsToUpgradeItem#1_Response": loyalty_rewards.RedeemPointsResponse,
    "LoyaltyRewards.RegisterForSteamDeckRewards#1_Request": loyalty_rewards.RegisterForSteamDeckRewardsRequest,
    "LoyaltyRewards.RegisterForSteamDeckRewards#1_Response": loyalty_rewards.RegisterForSteamDeckRewardsResponse,
    ...
    "PublishedFileClient.NotifyFileSubscribed#1_Request": published_file.FileSubscribedNotification,
    "PublishedFileClient.NotifyFileUnsubscribed#1_Request": published_file.FileUnsubscribedNotification,
    "PublishedFileClient.NotifyFileDeleted#1_Request": published_file.FileDeletedClientNotification,
