...
_CDATAPUBLISHER_CLIENTCONTENTCORRUPTIONREPORT_NOTIFICATION = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CDataPublisher_ClientContentCorruptionReport_Notification.download_source', index=2,
        ...
        _descriptor.FieldDescriptor(
            name='is_manifest', full_name='CDataPublisher_ClientContentCorruptionReport_Notification.is_manifest',
            index=5,
        ...
        _descriptor.FieldDescriptor(
            name='object_size', full_name='CDataPublisher_ClientContentCorruptionReport_Notification.object_size',
            index=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CDataPublisher_ClientContentCorruptionReport_Notification.corruption_type', index=7,
        ...
        _descriptor.FieldDescriptor(
            name='used_https', full_name='CDataPublisher_ClientContentCorruptionReport_Notification.used_https',
            index=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CDataPublisher_ClientContentCorruptionReport_Notification.oc_proxy_detected', index=9,
...
_CVALVEHWSURVEY_GETSURVEYSCHEDULE_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='surveydatetokenversion', full_name='CValveHWSurvey_GetSurveySchedule_Request.surveydatetokenversion',
            index=1,
...
_CVALVEHWSURVEY_GETSURVEYSCHEDULE_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='surveydatetokenversion', full_name='CValveHWSurvey_GetSurveySchedule_Response.surveydatetokenversion',
            index=1,
            number=2, type=6, cpp_type=4, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
...
DESCRIPTOR.message_types_by_name[
    'CDataPublisher_ClientContentCorruptionReport_Notification'] = _CDATAPUBLISHER_CLIENTCONTENTCORRUPTIONREPORT_NOTIFICATION
DESCRIPTOR.message_types_by_name['CValveHWSurvey_GetSurveySchedule_Request'] = _CVALVEHWSURVEY_GETSURVEYSCHEDULE_REQUEST
DESCRIPTOR.message_types_by_name[
    'CValveHWSurvey_GetSurveySchedule_Response'] = _CVALVEHWSURVEY_GETSURVEYSCHEDULE_RESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

CDataPublisher_ClientContentCorruptionReport_Notification = _reflection.GeneratedProtocolMessageType(
    'CDataPublisher_ClientContentCorruptionReport_Notification', (_message.Message,), dict(
...
CValveHWSurvey_GetSurveySchedule_Request = _reflection.GeneratedProtocolMessageType(
    'CValveHWSurvey_GetSurveySchedule_Request', (_message.Message,), dict(
...
CValveHWSurvey_GetSurveySchedule_Response = _reflection.GeneratedProtocolMessageType(
    'CValveHWSurvey_GetSurveySchedule_Response', (_message.Message,), dict(
