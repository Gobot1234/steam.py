...
_CTWOFACTOR_STATUS_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='revocation_attempts_remaining', full_name='CTwoFactor_Status_Response.revocation_attempts_remaining',
            index=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\030@Agent that added the authenticator (e.g., ios / android / other)'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='allow_external_authenticator', full_name='CTwoFactor_Status_Response.allow_external_authenticator',
            index=11,
            number=12, type=8, cpp_type=7, label=1,
            has_default_value=False, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\030=Allow a third-party authenticator (in addition to two-factor)'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\030AWhen the token was transferred from another device, if applicable'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CTWOFACTOR_ADDAUTHENTICATOR_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\0309Secret used for identity attestation (e.g., for eventing)'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
...
_CTWOFACTOR_FINALIZEADDAUTHENTICATOR_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=_b('\202\265\030\016steamid to use'), file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='authenticator_code', full_name='CTwoFactor_FinalizeAddAuthenticator_Request.authenticator_code',
            index=1,
        ...
        _descriptor.FieldDescriptor(
            name='authenticator_time', full_name='CTwoFactor_FinalizeAddAuthenticator_Request.authenticator_time',
            index=2,
...
_CTWOFACTOR_REMOVEAUTHENTICATOR_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CTwoFactor_RemoveAuthenticator_Request.remove_all_steamguard_cookies', index=3,
            number=7, type=8, cpp_type=7, label=1,
            has_default_value=False, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
_CTWOFACTOR_REMOVEAUTHENTICATOR_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\0307True if request succeeeded. The mobile app checks this.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CTwoFactor_RemoveAuthenticator_Response.revocation_attempts_remaining', index=2,
            number=5, type=13, cpp_type=3, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name[
    'CTwoFactor_FinalizeAddAuthenticator_Request'] = _CTWOFACTOR_FINALIZEADDAUTHENTICATOR_REQUEST
DESCRIPTOR.message_types_by_name[
    'CTwoFactor_FinalizeAddAuthenticator_Response'] = _CTWOFACTOR_FINALIZEADDAUTHENTICATOR_RESPONSE
...
DESCRIPTOR.message_types_by_name[
    'CTwoFactor_DestroyEmergencyCodes_Response'] = _CTWOFACTOR_DESTROYEMERGENCYCODES_RESPONSE
...
CTwoFactor_AddAuthenticator_Request = _reflection.GeneratedProtocolMessageType('CTwoFactor_AddAuthenticator_Request',
...
CTwoFactor_AddAuthenticator_Response = _reflection.GeneratedProtocolMessageType('CTwoFactor_AddAuthenticator_Response',
                                                                                (_message.Message,), dict(
...
CTwoFactor_SendEmail_Request = _reflection.GeneratedProtocolMessageType('CTwoFactor_SendEmail_Request',
                                                                        (_message.Message,), dict(
...
CTwoFactor_SendEmail_Response = _reflection.GeneratedProtocolMessageType('CTwoFactor_SendEmail_Response',
                                                                         (_message.Message,), dict(
...
CTwoFactor_FinalizeAddAuthenticator_Request = _reflection.GeneratedProtocolMessageType(
    'CTwoFactor_FinalizeAddAuthenticator_Request', (_message.Message,), dict(
...
CTwoFactor_FinalizeAddAuthenticator_Response = _reflection.GeneratedProtocolMessageType(
    'CTwoFactor_FinalizeAddAuthenticator_Response', (_message.Message,), dict(
...
CTwoFactor_RemoveAuthenticator_Request = _reflection.GeneratedProtocolMessageType(
    'CTwoFactor_RemoveAuthenticator_Request', (_message.Message,), dict(
...
CTwoFactor_RemoveAuthenticator_Response = _reflection.GeneratedProtocolMessageType(
    'CTwoFactor_RemoveAuthenticator_Response', (_message.Message,), dict(
...
CTwoFactor_CreateEmergencyCodes_Request = _reflection.GeneratedProtocolMessageType(
    'CTwoFactor_CreateEmergencyCodes_Request', (_message.Message,), dict(
...
CTwoFactor_CreateEmergencyCodes_Response = _reflection.GeneratedProtocolMessageType(
    'CTwoFactor_CreateEmergencyCodes_Response', (_message.Message,), dict(
...
CTwoFactor_DestroyEmergencyCodes_Request = _reflection.GeneratedProtocolMessageType(
    'CTwoFactor_DestroyEmergencyCodes_Request', (_message.Message,), dict(
...
CTwoFactor_DestroyEmergencyCodes_Response = _reflection.GeneratedProtocolMessageType(
    'CTwoFactor_DestroyEmergencyCodes_Response', (_message.Message,), dict(
...
CTwoFactor_ValidateToken_Request = _reflection.GeneratedProtocolMessageType('CTwoFactor_ValidateToken_Request',
                                                                            (_message.Message,), dict(
...
CTwoFactor_ValidateToken_Response = _reflection.GeneratedProtocolMessageType('CTwoFactor_ValidateToken_Response',
                                                                             (_message.Message,), dict(
