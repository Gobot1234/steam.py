...
_CUSERACCOUNT_GETAVAILABLEVALVEDISCOUNTPROMOTIONS_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='country_code', full_name='CUserAccount_GetAvailableValveDiscountPromotions_Request.country_code',
            index=0,
...
_CUSERACCOUNT_GETAVAILABLEVALVEDISCOUNTPROMOTIONS_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='promotions', full_name='CUserAccount_GetAvailableValveDiscountPromotions_Response.promotions',
            index=0,
...
_CUSERACCOUNT_GETACCOUNTLINKSTATUS_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='identity_verification', full_name='CUserAccount_GetAccountLinkStatus_Response.identity_verification',
            index=1,
...
_CACCOUNTLINKING_GETLINKEDACCOUNTINFO_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\0308if specified then only return this external account type'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='return_access_token', full_name='CAccountLinking_GetLinkedAccountInfo_Request.return_access_token',
            index=3,
            ...
            serialized_options=_b(
                '\202\265\030^if provided and true, then returns valid access token if available. It may refresh the token. '),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE_CEXTERNALACCOUNTTUPLE_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\0309required for all, can be a sentinal to verify correctness'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='access_token',
        ...
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030Jrequired for OAuth v1 and signing the message, provided with access token.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='is_valid',
            full_name='CAccountLinking_GetLinkedAccountInfo_Response.CExternalAccountTuple_Response.is_valid', index=6,
            number=7, type=8, cpp_type=7, label=1,
            has_default_value=False, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030zIf false, it means access token no longer work (expired, disconnected) and the link is now broken. Inform user to refresh.'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='external_accounts', full_name='CAccountLinking_GetLinkedAccountInfo_Response.external_accounts',
            index=0,
            number=1, type=11, cpp_type=10, label=3,
            has_default_value=False, default_value=[],
            message_type=None, enum_type=None, containing_type=None,
...
_CUSERACCOUNT_GETAVAILABLEVALVEDISCOUNTPROMOTIONS_RESPONSE.fields_by_name[
    'promotions'].message_type = _CUSERACCOUNT_GETAVAILABLEVALVEDISCOUNTPROMOTIONS_RESPONSE_VALVEDISCOUNTPROMOTIONDETAILS
_CUSERACCOUNT_GETFRIENDINVITETOKENS_RESPONSE.fields_by_name[
    'tokens'].message_type = _CUSERACCOUNT_CREATEFRIENDINVITETOKEN_RESPONSE
...
_CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE_CEXTERNALACCOUNTTUPLE_RESPONSE.fields_by_name[
    'external_type'].enum_type = _EEXTERNALACCOUNTTYPE
...
_CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE.fields_by_name[
    'external_accounts'].message_type = _CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE_CEXTERNALACCOUNTTUPLE_RESPONSE
_CEMBEDDEDCLIENT_AUTHORIZEDEVICE_RESPONSE.fields_by_name['token'].message_type = _CEMBEDDEDCLIENT_TOKEN
DESCRIPTOR.message_types_by_name[
    'CUserAccount_GetAvailableValveDiscountPromotions_Request'] = _CUSERACCOUNT_GETAVAILABLEVALVEDISCOUNTPROMOTIONS_REQUEST
DESCRIPTOR.message_types_by_name[
    'CUserAccount_GetAvailableValveDiscountPromotions_Response'] = _CUSERACCOUNT_GETAVAILABLEVALVEDISCOUNTPROMOTIONS_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CUserAccount_GetAccountLinkStatus_Request'] = _CUSERACCOUNT_GETACCOUNTLINKSTATUS_REQUEST
DESCRIPTOR.message_types_by_name[
    'CUserAccount_GetAccountLinkStatus_Response'] = _CUSERACCOUNT_GETACCOUNTLINKSTATUS_RESPONSE
DESCRIPTOR.message_types_by_name['CUserAccount_CancelLicenseForApp_Request'] = _CUSERACCOUNT_CANCELLICENSEFORAPP_REQUEST
DESCRIPTOR.message_types_by_name[
    'CUserAccount_CancelLicenseForApp_Response'] = _CUSERACCOUNT_CANCELLICENSEFORAPP_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CUserAccount_CreateFriendInviteToken_Request'] = _CUSERACCOUNT_CREATEFRIENDINVITETOKEN_REQUEST
DESCRIPTOR.message_types_by_name[
    'CUserAccount_CreateFriendInviteToken_Response'] = _CUSERACCOUNT_CREATEFRIENDINVITETOKEN_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CUserAccount_GetFriendInviteTokens_Request'] = _CUSERACCOUNT_GETFRIENDINVITETOKENS_REQUEST
DESCRIPTOR.message_types_by_name[
    'CUserAccount_GetFriendInviteTokens_Response'] = _CUSERACCOUNT_GETFRIENDINVITETOKENS_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CUserAccount_ViewFriendInviteToken_Request'] = _CUSERACCOUNT_VIEWFRIENDINVITETOKEN_REQUEST
DESCRIPTOR.message_types_by_name[
    'CUserAccount_ViewFriendInviteToken_Response'] = _CUSERACCOUNT_VIEWFRIENDINVITETOKEN_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CUserAccount_RedeemFriendInviteToken_Request'] = _CUSERACCOUNT_REDEEMFRIENDINVITETOKEN_REQUEST
DESCRIPTOR.message_types_by_name[
    'CUserAccount_RedeemFriendInviteToken_Response'] = _CUSERACCOUNT_REDEEMFRIENDINVITETOKEN_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CUserAccount_RevokeFriendInviteToken_Request'] = _CUSERACCOUNT_REVOKEFRIENDINVITETOKEN_REQUEST
DESCRIPTOR.message_types_by_name[
    'CUserAccount_RevokeFriendInviteToken_Response'] = _CUSERACCOUNT_REVOKEFRIENDINVITETOKEN_RESPONSE
...
DESCRIPTOR.message_types_by_name[
    'CAccountLinking_GetLinkedAccountInfo_Request'] = _CACCOUNTLINKING_GETLINKEDACCOUNTINFO_REQUEST
DESCRIPTOR.message_types_by_name[
    'CAccountLinking_GetLinkedAccountInfo_Response'] = _CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CEmbeddedClient_AuthorizeCurrentDevice_Request'] = _CEMBEDDEDCLIENT_AUTHORIZECURRENTDEVICE_REQUEST
...
CUserAccount_GetAvailableValveDiscountPromotions_Request = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_GetAvailableValveDiscountPromotions_Request', (_message.Message,), dict(
...
CUserAccount_GetAvailableValveDiscountPromotions_Response = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_GetAvailableValveDiscountPromotions_Response', (_message.Message,), dict(

        ValveDiscountPromotionDetails=_reflection.GeneratedProtocolMessageType('ValveDiscountPromotionDetails',
...
CUserAccount_GetAccountLinkStatus_Request = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_GetAccountLinkStatus_Request', (_message.Message,), dict(
...
CUserAccount_GetAccountLinkStatus_Response = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_GetAccountLinkStatus_Response', (_message.Message,), dict(
...
CUserAccount_CancelLicenseForApp_Request = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_CancelLicenseForApp_Request', (_message.Message,), dict(
...
CUserAccount_CancelLicenseForApp_Response = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_CancelLicenseForApp_Response', (_message.Message,), dict(
...
CUserAccount_CreateFriendInviteToken_Request = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_CreateFriendInviteToken_Request', (_message.Message,), dict(
...
CUserAccount_CreateFriendInviteToken_Response = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_CreateFriendInviteToken_Response', (_message.Message,), dict(
...
CUserAccount_GetFriendInviteTokens_Request = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_GetFriendInviteTokens_Request', (_message.Message,), dict(
...
CUserAccount_GetFriendInviteTokens_Response = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_GetFriendInviteTokens_Response', (_message.Message,), dict(
...
CUserAccount_ViewFriendInviteToken_Request = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_ViewFriendInviteToken_Request', (_message.Message,), dict(
...
CUserAccount_ViewFriendInviteToken_Response = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_ViewFriendInviteToken_Response', (_message.Message,), dict(
...
CUserAccount_RedeemFriendInviteToken_Request = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_RedeemFriendInviteToken_Request', (_message.Message,), dict(
...
CUserAccount_RedeemFriendInviteToken_Response = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_RedeemFriendInviteToken_Response', (_message.Message,), dict(
...
CUserAccount_RevokeFriendInviteToken_Request = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_RevokeFriendInviteToken_Request', (_message.Message,), dict(
...
CUserAccount_RevokeFriendInviteToken_Response = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_RevokeFriendInviteToken_Response', (_message.Message,), dict(
...
CUserAccount_RegisterCompatTool_Request = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_RegisterCompatTool_Request', (_message.Message,), dict(
...
CUserAccount_RegisterCompatTool_Response = _reflection.GeneratedProtocolMessageType(
    'CUserAccount_RegisterCompatTool_Response', (_message.Message,), dict(
...
CAccountLinking_GetLinkedAccountInfo_Request = _reflection.GeneratedProtocolMessageType(
    'CAccountLinking_GetLinkedAccountInfo_Request', (_message.Message,), dict(
...
CAccountLinking_GetLinkedAccountInfo_Response = _reflection.GeneratedProtocolMessageType(
    'CAccountLinking_GetLinkedAccountInfo_Response', (_message.Message,), dict(

        CExternalAccountTuple_Response=_reflection.GeneratedProtocolMessageType('CExternalAccountTuple_Response',
                                                                                (_message.Message,), dict(
...
CEmbeddedClient_AuthorizeCurrentDevice_Request = _reflection.GeneratedProtocolMessageType(
    'CEmbeddedClient_AuthorizeCurrentDevice_Request', (_message.Message,), dict(
...
CEmbeddedClient_AuthorizeDevice_Response = _reflection.GeneratedProtocolMessageType(
    'CEmbeddedClient_AuthorizeDevice_Response', (_message.Message,), dict(
...
_CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE_CEXTERNALACCOUNTTUPLE_RESPONSE.fields_by_name[
    'external_id']._options = None
_CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE_CEXTERNALACCOUNTTUPLE_RESPONSE.fields_by_name[
    'external_user_name']._options = None
_CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE_CEXTERNALACCOUNTTUPLE_RESPONSE.fields_by_name[
    'external_url']._options = None
_CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE_CEXTERNALACCOUNTTUPLE_RESPONSE.fields_by_name[
    'access_token']._options = None
_CACCOUNTLINKING_GETLINKEDACCOUNTINFO_RESPONSE_CEXTERNALACCOUNTTUPLE_RESPONSE.fields_by_name[
    'access_token_secret']._options = None
...
_USERACCOUNT = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030FCreate a limited-use token that can be used to create a friend request'),
        ),
        _descriptor.MethodDescriptor(
...
_ACCOUNTLINKING = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030XList all my active linked external accounts; may be requested to return the access token'),
        ),
    ])
...
_EMBEDDEDCLIENT = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030GUse a logged-in (password/etc) session to create a durable access token'),
        ),
    ])
