    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030\223\001The name of the variable in the localized text -- anywhere that %variablename% is found within the text it will be substituded with the given value'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030\202\001The value of the variable to substitute in the localized text in place of the given variable.  Can itself be a localization token.'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CGAMENOTIFICATIONS_LOCALIZEDTEXT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\0305A localization token that maps to the desired string.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030XA list of variables values to substitute in any variables found in the localized string.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030kText rendered in the requested language, complete with variable substitutions, if a language was specified.'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CGAMENOTIFICATIONS_USERSTATUS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030\217\001The user\'s state.  ready -- the user is ready to play.  waiting -- The game is waiting on an action from the user. completed, the game is over.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030NTitle of the session to display to this user in their list of active sessions.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030ZSubtitle of the session to display to this user user within their list of active sessions.'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CGAMENOTIFICATIONS_CREATESESSION_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030jGame-specified context value the game can used to associate the session with some object on their backend.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030MThe title of the session to be displayed within each user\'s list of sessions.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
        ...
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030\254\001(Optional) steamid to make the request on behalf of -- if specified, the user must be in the session and all users being added to the session must be friends with the user.'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CGAMENOTIFICATIONS_DELETESESSION_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030e(Optional) steamid to make the request on behalf of -- if specified, the user must be in the session.'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CGAMENOTIFICATIONS_UPDATESESSION_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030Z(Optional) The new title of the session.  If not specified, the title will not be changed.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030\231\001(Optional) A list of users whose state will be updated to reflect the given state. If the users are not already in the session, they will be added to it.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
...
_CGAMENOTIFICATIONS_ENUMERATESESSIONS_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030kThe sessionid to request details for. Optional. If not specified, all the user\'s sessions will be returned.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='include_all_user_messages',
            full_name='CGameNotifications_EnumerateSessions_Request.include_all_user_messages', index=1,
            number=3, type=8, cpp_type=7, label=1,
            has_default_value=False, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030g(Optional) Boolean determining whether the message for all users should be included. Defaults to false.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='include_auth_user_message',
            full_name='CGameNotifications_EnumerateSessions_Request.include_auth_user_message', index=2,
            number=4, type=8, cpp_type=7, label=1,
            has_default_value=False, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030t(Optional) Boolean determining whether the message for the authenticated user should be included. Defaults to false.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
...
_CGAMENOTIFICATIONS_GETSESSIONDETAILS_REQUEST_REQUESTEDSESSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='sessionid', full_name='CGameNotifications_GetSessionDetails_Request.RequestedSession.sessionid',
            index=0,
            number=1, type=4, cpp_type=4, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
...
_CGAMENOTIFICATIONS_UPDATENOTIFICATIONSETTINGS_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='CGameNotifications_UpdateNotificationSettings_Request.game_notification_settings', index=0,
            number=1, type=11, cpp_type=10, label=3,
            has_default_value=False, default_value=[],
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
_CGAMENOTIFICATIONS_ONNOTIFICATIONSREQUESTED_NOTIFICATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\0309steamid of the user who notifications were requested for.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
...
_CGAMENOTIFICATIONS_ONUSERSTATUSCHANGED_NOTIFICATION = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\030AThe sessionid of the session where the user\'s status was changed.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\0309The appid of the session where the user\'s status changed.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
...
_CGAMENOTIFICATIONS_GETSESSIONDETAILS_REQUEST.fields_by_name[
    'sessions'].message_type = _CGAMENOTIFICATIONS_GETSESSIONDETAILS_REQUEST_REQUESTEDSESSION
...
_CGAMENOTIFICATIONS_UPDATENOTIFICATIONSETTINGS_REQUEST.fields_by_name[
    'game_notification_settings'].message_type = _GAMENOTIFICATIONSETTINGS
_CGAMENOTIFICATIONS_ONUSERSTATUSCHANGED_NOTIFICATION.fields_by_name[
    'status'].message_type = _CGAMENOTIFICATIONS_USERSTATUS
...
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_CreateSession_Response'] = _CGAMENOTIFICATIONS_CREATESESSION_RESPONSE
DESCRIPTOR.message_types_by_name['CGameNotifications_DeleteSession_Request'] = _CGAMENOTIFICATIONS_DELETESESSION_REQUEST
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_DeleteSession_Response'] = _CGAMENOTIFICATIONS_DELETESESSION_RESPONSE
DESCRIPTOR.message_types_by_name['CGameNotifications_UpdateSession_Request'] = _CGAMENOTIFICATIONS_UPDATESESSION_REQUEST
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_UpdateSession_Response'] = _CGAMENOTIFICATIONS_UPDATESESSION_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_EnumerateSessions_Request'] = _CGAMENOTIFICATIONS_ENUMERATESESSIONS_REQUEST
DESCRIPTOR.message_types_by_name['CGameNotifications_Session'] = _CGAMENOTIFICATIONS_SESSION
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_EnumerateSessions_Response'] = _CGAMENOTIFICATIONS_ENUMERATESESSIONS_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_GetSessionDetails_Request'] = _CGAMENOTIFICATIONS_GETSESSIONDETAILS_REQUEST
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_GetSessionDetails_Response'] = _CGAMENOTIFICATIONS_GETSESSIONDETAILS_RESPONSE
DESCRIPTOR.message_types_by_name['GameNotificationSettings'] = _GAMENOTIFICATIONSETTINGS
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_UpdateNotificationSettings_Request'] = _CGAMENOTIFICATIONS_UPDATENOTIFICATIONSETTINGS_REQUEST
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_UpdateNotificationSettings_Response'] = _CGAMENOTIFICATIONS_UPDATENOTIFICATIONSETTINGS_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_OnNotificationsRequested_Notification'] = _CGAMENOTIFICATIONS_ONNOTIFICATIONSREQUESTED_NOTIFICATION
DESCRIPTOR.message_types_by_name[
    'CGameNotifications_OnUserStatusChanged_Notification'] = _CGAMENOTIFICATIONS_ONUSERSTATUSCHANGED_NOTIFICATION
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

CGameNotifications_Variable = _reflection.GeneratedProtocolMessageType('CGameNotifications_Variable',
...
CGameNotifications_LocalizedText = _reflection.GeneratedProtocolMessageType('CGameNotifications_LocalizedText',
                                                                            (_message.Message,), dict(
...
CGameNotifications_UserStatus = _reflection.GeneratedProtocolMessageType('CGameNotifications_UserStatus',
                                                                         (_message.Message,), dict(
...
CGameNotifications_CreateSession_Request = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_CreateSession_Request', (_message.Message,), dict(
...
CGameNotifications_CreateSession_Response = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_CreateSession_Response', (_message.Message,), dict(
...
CGameNotifications_DeleteSession_Request = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_DeleteSession_Request', (_message.Message,), dict(
...
CGameNotifications_DeleteSession_Response = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_DeleteSession_Response', (_message.Message,), dict(
...
CGameNotifications_UpdateSession_Request = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_UpdateSession_Request', (_message.Message,), dict(
...
CGameNotifications_UpdateSession_Response = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_UpdateSession_Response', (_message.Message,), dict(
...
CGameNotifications_EnumerateSessions_Request = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_EnumerateSessions_Request', (_message.Message,), dict(
...
CGameNotifications_EnumerateSessions_Response = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_EnumerateSessions_Response', (_message.Message,), dict(
...
CGameNotifications_GetSessionDetails_Request = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_GetSessionDetails_Request', (_message.Message,), dict(
...
CGameNotifications_GetSessionDetails_Response = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_GetSessionDetails_Response', (_message.Message,), dict(
...
CGameNotifications_UpdateNotificationSettings_Request = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_UpdateNotificationSettings_Request', (_message.Message,), dict(
...
CGameNotifications_UpdateNotificationSettings_Response = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_UpdateNotificationSettings_Response', (_message.Message,), dict(
...
CGameNotifications_OnNotificationsRequested_Notification = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_OnNotificationsRequested_Notification', (_message.Message,), dict(
...
CGameNotifications_OnUserStatusChanged_Notification = _reflection.GeneratedProtocolMessageType(
    'CGameNotifications_OnUserStatusChanged_Notification', (_message.Message,), dict(
...
_CGAMENOTIFICATIONS_GETSESSIONDETAILS_REQUEST_REQUESTEDSESSION.fields_by_name[
    'include_auth_user_message']._options = None
...
GameNotifications_Stub = service_reflection.GeneratedServiceStubType('GameNotifications_Stub', (GameNotifications,),
                                                                     dict(
                                                                         DESCRIPTOR=_GAMENOTIFICATIONS,
                                                                         __module__='steammessages_gamenotifications_pb2'
                                                                     ))
...
GameNotificationsClient_Stub = service_reflection.GeneratedServiceStubType('GameNotificationsClient_Stub',
                                                                           (GameNotificationsClient,), dict(
        DESCRIPTOR=_GAMENOTIFICATIONSCLIENT,
        __module__='steammessages_gamenotifications_pb2'
    ))
