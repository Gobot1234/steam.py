...
_VIDEOBOOKMARK = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\0304when we recorded it was last modified. Not settable.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030KList of App IDs to grab bookmarks for. Can be empty if using updated_since.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030aOnly return results after time. Min value is 1. (seconds since epoch January 1st, 1970 Unix Time)'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
DESCRIPTOR.message_types_by_name[
    'CFovasVideo_ClientGetOPFSettings_Response'] = _CFOVASVIDEO_CLIENTGETOPFSETTINGS_RESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

CVideo_ClientGetVideoURL_Request = _reflection.GeneratedProtocolMessageType('CVideo_ClientGetVideoURL_Request',
...
CVideo_ClientGetVideoURL_Response = _reflection.GeneratedProtocolMessageType('CVideo_ClientGetVideoURL_Response',
                                                                             (_message.Message,), dict(
...
CVideo_SetVideoBookmark_Notification = _reflection.GeneratedProtocolMessageType('CVideo_SetVideoBookmark_Notification',
                                                                                (_message.Message,), dict(
...
CVideo_GetVideoBookmarks_Request = _reflection.GeneratedProtocolMessageType('CVideo_GetVideoBookmarks_Request',
                                                                            (_message.Message,), dict(
...
CVideo_GetVideoBookmarks_Response = _reflection.GeneratedProtocolMessageType('CVideo_GetVideoBookmarks_Response',
                                                                             (_message.Message,), dict(
...
CVideo_UnlockedH264_Notification = _reflection.GeneratedProtocolMessageType('CVideo_UnlockedH264_Notification',
                                                                            (_message.Message,), dict(
...
CFovasVideo_ClientGetOPFSettings_Request = _reflection.GeneratedProtocolMessageType(
    'CFovasVideo_ClientGetOPFSettings_Request', (_message.Message,), dict(
...
CFovasVideo_ClientGetOPFSettings_Response = _reflection.GeneratedProtocolMessageType(
    'CFovasVideo_ClientGetOPFSettings_Response', (_message.Message,), dict(
...
_VIDEO = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030uBookmarks the locations in the video the user has reached. As as record playback settings per video. Fire and forget.'),
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030cReturns the video bookmarks locations for the specific videos. Includes playback settings per video'),
        ),
    ])
...
_FOVASVIDEO = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030PRetrieve the OPF settings JSON blob. Available via the Client for 360 Player App'),
        ),
    ])
