...
_CPLAYER_INCOMINGINVITEMUTUALFRIENDLIST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CPlayer_IncomingInviteMutualFriendList.mutual_friend_account_ids', index=1,
...
_CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE_FRIENDSGAMEPLAYINFO = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='minutes_played',
            full_name='CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfo.minutes_played', index=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CPlayer_GetFriendsGameplayInfo_Response.FriendsGameplayInfo.minutes_played_forever', index=2,
...
_CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE_OWNGAMEPLAYINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='minutes_played', full_name='CPlayer_GetFriendsGameplayInfo_Response.OwnGameplayInfo.minutes_played',
            index=1,
            number=2, type=13, cpp_type=3, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
        ...
        _descriptor.FieldDescriptor(
            name='minutes_played_forever',
            full_name='CPlayer_GetFriendsGameplayInfo_Response.OwnGameplayInfo.minutes_played_forever', index=2,
            number=3, type=13, cpp_type=3, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='in_wishlist', full_name='CPlayer_GetFriendsGameplayInfo_Response.OwnGameplayInfo.in_wishlist',
            index=3,
...
_CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE = _descriptor.Descriptor(
    ...
    nested_types=[_CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE_FRIENDSGAMEPLAYINFO,
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030fLanguage for which to query about news items (for the being_discussed results). DEPRECATED AND UNUSED.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\030>Flags describing the request; see EGetFriendsAppsActivityFlags'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE_FRIENDPLAYTIME = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='minutes_played_this_week',
            full_name='CPlayer_GetFriendsAppsActivity_Response.FriendPlayTime.minutes_played_this_week', index=1,
            number=2, type=13, cpp_type=3, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030MMinutes this friend played the game (from the enclosing structure) this week.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='minutes_played_two_weeks',
            full_name='CPlayer_GetFriendsAppsActivity_Response.FriendPlayTime.minutes_played_two_weeks', index=2,
            number=3, type=13, cpp_type=3, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030WMinutes this friend played the game (from the enclosing structure) in the past 2 weeks.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='minutes_played_forever',
            full_name='CPlayer_GetFriendsAppsActivity_Response.FriendPlayTime.minutes_played_forever', index=3,
            number=4, type=13, cpp_type=3, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030LMinutes this friend played the game (from the enclosing structure) all time.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030mNumber of events involving this user & app. (Only set for results in being_discussed.) DEPRECATED AND UNUSED.'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE_APPFRIENDSINFO = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030{Friends (w/ playtime) that meet a specific criteria -- e.g. for trending, only includes friends w/ more playtime this week.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='display_order', full_name='CPlayer_GetFriendsAppsActivity_Response.AppFriendsInfo.display_order',
            index=2,
            number=3, type=13, cpp_type=3, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030nIndex indicating the order in which this app should be displayed, relative to other apps in the same response.'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030iApps that friends have played more this week than last, with list of friends who\'ve played more this week'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030]Apps friends have played in the past two weeks for which the user recently acquired a license'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030PApps friends have played in the past two weeks for which the user has no license'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030aApps friends have played in the past two weeks, for which the user has a license, sorted by count'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030tApps friends have played in the past two weeks which the user has neither purchased nor played in the past two weeks'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030kOwned apps that friends have posted status or screenshots for in the past two weeks. DEPRECATED AND UNUSED.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\030AOwned apps that none of your friends had played prior to 2 weeks.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\030AOwned apps that friends hadn\'t played for a while, but are again.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='active_friend_count', full_name='CPlayer_GetFriendsAppsActivity_Response.active_friend_count',
            index=8,
            number=9, type=13, cpp_type=3, label=1,
            has_default_value=True, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\030BNumber of friends with non-trivial activity in the past two weeks.'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
    nested_types=[_CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE_FRIENDPLAYTIME,
...
_CPLAYER_GETACHIEVEMENTSPROGRESS_RESPONSE_ACHIEVEMENTPROGRESS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='percentage', full_name='CPlayer_GetAchievementsProgress_Response.AchievementProgress.percentage',
            index=3,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='all_unlocked', full_name='CPlayer_GetAchievementsProgress_Response.AchievementProgress.all_unlocked',
            index=4,
            number=5, type=8, cpp_type=7, label=1,
            has_default_value=False, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='cache_time', full_name='CPlayer_GetAchievementsProgress_Response.AchievementProgress.cache_time',
            index=5,
...
_CPLAYER_GETACHIEVEMENTSPROGRESS_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='achievement_progress', full_name='CPlayer_GetAchievementsProgress_Response.achievement_progress',
            index=0,
            number=1, type=11, cpp_type=10, label=3,
            has_default_value=False, default_value=[],
            message_type=None, enum_type=None, containing_type=None,
...
_CPLAYER_GETLASTPLAYEDTIMES_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\030?The most recent last-played time the client already knows about'),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CPLAYER_GETLASTPLAYEDTIMES_RESPONSE_GAME = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CPlayer_GetLastPlayedTimes_Response.Game.playtime_windows_forever', index=5,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='playtime_mac_forever', full_name='CPlayer_GetLastPlayedTimes_Response.Game.playtime_mac_forever',
            index=6,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='playtime_linux_forever', full_name='CPlayer_GetLastPlayedTimes_Response.Game.playtime_linux_forever',
            index=7,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='first_windows_playtime', full_name='CPlayer_GetLastPlayedTimes_Response.Game.first_windows_playtime',
            index=8,
            number=9, type=13, cpp_type=3, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='first_linux_playtime', full_name='CPlayer_GetLastPlayedTimes_Response.Game.first_linux_playtime',
            index=10,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='last_windows_playtime', full_name='CPlayer_GetLastPlayedTimes_Response.Game.last_windows_playtime',
            index=11,
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='last_linux_playtime', full_name='CPlayer_GetLastPlayedTimes_Response.Game.last_linux_playtime',
            index=13,
...
_CPLAYER_ADDFRIEND_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\0306True if the operation was successful, false otherwise.'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            ...
            is_extension=False, extension_scope=None,
            serialized_options=_b(
                '\202\265\030ethe resulting relationship.  Depending on state, may move directly to friends rather than invite sent'),
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
...
_CPLAYER_IGNOREFRIEND_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=_b('\202\265\0308If set, remove from ignore/block list instead of adding '),
            file=DESCRIPTOR),
    ],
    extensions=[
    ],
...
_CPLAYER_COMMUNITYPREFERENCES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='hide_adult_content_violence', full_name='CPlayer_CommunityPreferences.hide_adult_content_violence',
            index=0,
            number=1, type=8, cpp_type=7, label=1,
...
_CPLAYER_GETNEWSTEAMANNOUNCEMENTSTATE_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='CPlayer_GetNewSteamAnnouncementState_Response.announcement_headline', index=1,
            number=2, type=9, cpp_type=9, label=1,
            has_default_value=False, default_value=_b("").decode('utf-8'),
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='announcement_url', full_name='CPlayer_GetNewSteamAnnouncementState_Response.announcement_url',
            index=2,
            number=3, type=9, cpp_type=9, label=1,
            has_default_value=False, default_value=_b("").decode('utf-8'),
            message_type=None, enum_type=None, containing_type=None,
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='announcement_gid', full_name='CPlayer_GetNewSteamAnnouncementState_Response.announcement_gid',
            index=4,
...
_CPLAYER_UPDATESTEAMANNOUNCEMENTLASTREAD_REQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='announcement_gid', full_name='CPlayer_UpdateSteamAnnouncementLastRead_Request.announcement_gid',
            index=0,
            number=1, type=4, cpp_type=4, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
...
_CPLAYER_GETDURATIONCONTROL_RESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='is_steamchina_account', full_name='CPlayer_GetDurationControl_Response.is_steamchina_account',
            index=3,
            number=4, type=8, cpp_type=7, label=1,
            has_default_value=False, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
...
_CPLAYER_NEWSTEAMANNOUNCEMENTSTATE_NOTIFICATION = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='announcement_headline',
            full_name='CPlayer_NewSteamAnnouncementState_Notification.announcement_headline', index=1,
            number=2, type=9, cpp_type=9, label=1,
            has_default_value=False, default_value=_b("").decode('utf-8'),
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='announcement_url', full_name='CPlayer_NewSteamAnnouncementState_Notification.announcement_url',
            index=2,
            number=3, type=9, cpp_type=9, label=1,
            has_default_value=False, default_value=_b("").decode('utf-8'),
            message_type=None, enum_type=None, containing_type=None,
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='announcement_gid', full_name='CPlayer_NewSteamAnnouncementState_Notification.announcement_gid',
            index=4,
            number=5, type=4, cpp_type=4, label=1,
            has_default_value=False, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
...
_CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE.fields_by_name[
    'your_info'].message_type = _CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE_OWNGAMEPLAYINFO
_CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE.fields_by_name[
    'in_game'].message_type = _CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE_FRIENDSGAMEPLAYINFO
_CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE.fields_by_name[
    'played_recently'].message_type = _CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE_FRIENDSGAMEPLAYINFO
_CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE.fields_by_name[
    'played_ever'].message_type = _CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE_FRIENDSGAMEPLAYINFO
_CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE.fields_by_name[
    'owns'].message_type = _CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE_FRIENDSGAMEPLAYINFO
_CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE.fields_by_name[
    'in_wishlist'].message_type = _CPLAYER_GETFRIENDSGAMEPLAYINFO_RESPONSE_FRIENDSGAMEPLAYINFO
_CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE_FRIENDPLAYTIME.containing_type = _CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE
_CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE_APPFRIENDSINFO.fields_by_name[
    'friends'].message_type = _CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE_FRIENDPLAYTIME
...
_CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE.fields_by_name[
    'unowned'].message_type = _CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE_APPFRIENDSINFO
_CPLAYER_GETFRIENDSAPPSACTIVITY_RESPONSE.fields_by_name[
...
_CPLAYER_GETACHIEVEMENTSPROGRESS_RESPONSE.fields_by_name[
    'achievement_progress'].message_type = _CPLAYER_GETACHIEVEMENTSPROGRESS_RESPONSE_ACHIEVEMENTPROGRESS
...
_CPLAYER_GETNICKNAMELIST_RESPONSE.fields_by_name[
    'nicknames'].message_type = _CPLAYER_GETNICKNAMELIST_RESPONSE_PLAYERNICKNAME
...
_CPLAYER_COMMUNITYPREFERENCESCHANGED_NOTIFICATION.fields_by_name[
    'preferences'].message_type = _CPLAYER_COMMUNITYPREFERENCES
...
DESCRIPTOR.message_types_by_name[
    'CPlayer_GetMutualFriendsForIncomingInvites_Request'] = _CPLAYER_GETMUTUALFRIENDSFORINCOMINGINVITES_REQUEST
DESCRIPTOR.message_types_by_name['CPlayer_IncomingInviteMutualFriendList'] = _CPLAYER_INCOMINGINVITEMUTUALFRIENDLIST
DESCRIPTOR.message_types_by_name[
    'CPlayer_GetMutualFriendsForIncomingInvites_Response'] = _CPLAYER_GETMUTUALFRIENDSFORINCOMINGINVITES_RESPONSE
...
DESCRIPTOR.message_types_by_name[
    'CPlayer_GetNewSteamAnnouncementState_Request'] = _CPLAYER_GETNEWSTEAMANNOUNCEMENTSTATE_REQUEST
DESCRIPTOR.message_types_by_name[
    'CPlayer_GetNewSteamAnnouncementState_Response'] = _CPLAYER_GETNEWSTEAMANNOUNCEMENTSTATE_RESPONSE
DESCRIPTOR.message_types_by_name[
    'CPlayer_UpdateSteamAnnouncementLastRead_Request'] = _CPLAYER_UPDATESTEAMANNOUNCEMENTLASTREAD_REQUEST
DESCRIPTOR.message_types_by_name[
    'CPlayer_UpdateSteamAnnouncementLastRead_Response'] = _CPLAYER_UPDATESTEAMANNOUNCEMENTLASTREAD_RESPONSE
...
DESCRIPTOR.message_types_by_name[
    'CPlayer_FriendNicknameChanged_Notification'] = _CPLAYER_FRIENDNICKNAMECHANGED_NOTIFICATION
DESCRIPTOR.message_types_by_name[
    'CPlayer_NewSteamAnnouncementState_Notification'] = _CPLAYER_NEWSTEAMANNOUNCEMENTSTATE_NOTIFICATION
DESCRIPTOR.message_types_by_name[
    'CPlayer_CommunityPreferencesChanged_Notification'] = _CPLAYER_COMMUNITYPREFERENCESCHANGED_NOTIFICATION
DESCRIPTOR.message_types_by_name[
    'CPlayer_PerFriendPreferencesChanged_Notification'] = _CPLAYER_PERFRIENDPREFERENCESCHANGED_NOTIFICATION
DESCRIPTOR.message_types_by_name[
    'CPlayer_PrivacySettingsChanged_Notification'] = _CPLAYER_PRIVACYSETTINGSCHANGED_NOTIFICATION
...
CPlayer_GetMutualFriendsForIncomingInvites_Request = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetMutualFriendsForIncomingInvites_Request', (_message.Message,), dict(
...
CPlayer_IncomingInviteMutualFriendList = _reflection.GeneratedProtocolMessageType(
    'CPlayer_IncomingInviteMutualFriendList', (_message.Message,), dict(
...
CPlayer_GetMutualFriendsForIncomingInvites_Response = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetMutualFriendsForIncomingInvites_Response', (_message.Message,), dict(
...
CPlayer_GetFriendsGameplayInfo_Request = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetFriendsGameplayInfo_Request', (_message.Message,), dict(
...
CPlayer_GetFriendsGameplayInfo_Response = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetFriendsGameplayInfo_Response', (_message.Message,), dict(
...
CPlayer_GetFriendsAppsActivity_Request = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetFriendsAppsActivity_Request', (_message.Message,), dict(
...
CPlayer_GetFriendsAppsActivity_Response = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetFriendsAppsActivity_Response', (_message.Message,), dict(
...
CPlayer_GetGameBadgeLevels_Request = _reflection.GeneratedProtocolMessageType('CPlayer_GetGameBadgeLevels_Request',
...
CPlayer_GetGameBadgeLevels_Response = _reflection.GeneratedProtocolMessageType('CPlayer_GetGameBadgeLevels_Response',
                                                                               (_message.Message,), dict(
...
CPlayer_GetEmoticonList_Request = _reflection.GeneratedProtocolMessageType('CPlayer_GetEmoticonList_Request',
                                                                           (_message.Message,), dict(
...
CPlayer_GetEmoticonList_Response = _reflection.GeneratedProtocolMessageType('CPlayer_GetEmoticonList_Response',
                                                                            (_message.Message,), dict(
...
CPlayer_GetAchievementsProgress_Request = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetAchievementsProgress_Request', (_message.Message,), dict(
...
CPlayer_GetAchievementsProgress_Response = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetAchievementsProgress_Response', (_message.Message,), dict(
...
CPlayer_PostStatusToFriends_Request = _reflection.GeneratedProtocolMessageType('CPlayer_PostStatusToFriends_Request',
                                                                               (_message.Message,), dict(
...
CPlayer_GetPostedStatus_Request = _reflection.GeneratedProtocolMessageType('CPlayer_GetPostedStatus_Request',
                                                                           (_message.Message,), dict(
...
CPlayer_DeletePostedStatus_Request = _reflection.GeneratedProtocolMessageType('CPlayer_DeletePostedStatus_Request',
                                                                              (_message.Message,), dict(
...
CPlayer_GetLastPlayedTimes_Response = _reflection.GeneratedProtocolMessageType('CPlayer_GetLastPlayedTimes_Response',
                                                                               (_message.Message,), dict(
...
CPlayer_GetNicknameList_Request = _reflection.GeneratedProtocolMessageType('CPlayer_GetNicknameList_Request',
                                                                           (_message.Message,), dict(
...
CPlayer_GetNicknameList_Response = _reflection.GeneratedProtocolMessageType('CPlayer_GetNicknameList_Response',
                                                                            (_message.Message,), dict(
...
CPlayer_GetPerFriendPreferences_Request = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetPerFriendPreferences_Request', (_message.Message,), dict(
...
CPlayer_GetPerFriendPreferences_Response = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetPerFriendPreferences_Response', (_message.Message,), dict(
...
CPlayer_SetPerFriendPreferences_Request = _reflection.GeneratedProtocolMessageType(
    'CPlayer_SetPerFriendPreferences_Request', (_message.Message,), dict(
...
CPlayer_SetPerFriendPreferences_Response = _reflection.GeneratedProtocolMessageType(
    'CPlayer_SetPerFriendPreferences_Response', (_message.Message,), dict(
...
CPlayer_RemoveFriend_Request = _reflection.GeneratedProtocolMessageType('CPlayer_RemoveFriend_Request',
                                                                        (_message.Message,), dict(
...
CPlayer_RemoveFriend_Response = _reflection.GeneratedProtocolMessageType('CPlayer_RemoveFriend_Response',
                                                                         (_message.Message,), dict(
...
CPlayer_IgnoreFriend_Request = _reflection.GeneratedProtocolMessageType('CPlayer_IgnoreFriend_Request',
                                                                        (_message.Message,), dict(
...
CPlayer_IgnoreFriend_Response = _reflection.GeneratedProtocolMessageType('CPlayer_IgnoreFriend_Response',
                                                                         (_message.Message,), dict(
...
CPlayer_GetCommunityPreferences_Request = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetCommunityPreferences_Request', (_message.Message,), dict(
...
CPlayer_CommunityPreferences = _reflection.GeneratedProtocolMessageType('CPlayer_CommunityPreferences',
                                                                        (_message.Message,), dict(
...
CPlayer_GetCommunityPreferences_Response = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetCommunityPreferences_Response', (_message.Message,), dict(
...
CPlayer_SetCommunityPreferences_Request = _reflection.GeneratedProtocolMessageType(
    'CPlayer_SetCommunityPreferences_Request', (_message.Message,), dict(
...
CPlayer_SetCommunityPreferences_Response = _reflection.GeneratedProtocolMessageType(
    'CPlayer_SetCommunityPreferences_Response', (_message.Message,), dict(
...
CPlayer_GetNewSteamAnnouncementState_Request = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetNewSteamAnnouncementState_Request', (_message.Message,), dict(
...
CPlayer_GetNewSteamAnnouncementState_Response = _reflection.GeneratedProtocolMessageType(
    'CPlayer_GetNewSteamAnnouncementState_Response', (_message.Message,), dict(
...
CPlayer_UpdateSteamAnnouncementLastRead_Request = _reflection.GeneratedProtocolMessageType(
    'CPlayer_UpdateSteamAnnouncementLastRead_Request', (_message.Message,), dict(
...
CPlayer_UpdateSteamAnnouncementLastRead_Response = _reflection.GeneratedProtocolMessageType(
    'CPlayer_UpdateSteamAnnouncementLastRead_Response', (_message.Message,), dict(
...
CPlayer_GetPrivacySettings_Request = _reflection.GeneratedProtocolMessageType('CPlayer_GetPrivacySettings_Request',
                                                                              (_message.Message,), dict(
...
CPlayer_GetPrivacySettings_Response = _reflection.GeneratedProtocolMessageType('CPlayer_GetPrivacySettings_Response',
                                                                               (_message.Message,), dict(
...
CPlayer_GetDurationControl_Request = _reflection.GeneratedProtocolMessageType('CPlayer_GetDurationControl_Request',
                                                                              (_message.Message,), dict(
...
CPlayer_GetDurationControl_Response = _reflection.GeneratedProtocolMessageType('CPlayer_GetDurationControl_Response',
                                                                               (_message.Message,), dict(
...
CPlayer_LastPlayedTimes_Notification = _reflection.GeneratedProtocolMessageType('CPlayer_LastPlayedTimes_Notification',
                                                                                (_message.Message,), dict(
...
CPlayer_FriendNicknameChanged_Notification = _reflection.GeneratedProtocolMessageType(
    'CPlayer_FriendNicknameChanged_Notification', (_message.Message,), dict(
...
CPlayer_NewSteamAnnouncementState_Notification = _reflection.GeneratedProtocolMessageType(
    'CPlayer_NewSteamAnnouncementState_Notification', (_message.Message,), dict(
...
CPlayer_CommunityPreferencesChanged_Notification = _reflection.GeneratedProtocolMessageType(
    'CPlayer_CommunityPreferencesChanged_Notification', (_message.Message,), dict(
...
CPlayer_PerFriendPreferencesChanged_Notification = _reflection.GeneratedProtocolMessageType(
    'CPlayer_PerFriendPreferencesChanged_Notification', (_message.Message,), dict(
...
CPlayer_PrivacySettingsChanged_Notification = _reflection.GeneratedProtocolMessageType(
    'CPlayer_PrivacySettingsChanged_Notification', (_message.Message,), dict(
...
_PLAYER = _descriptor.ServiceDescriptor(
    ...
    methods=[
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030ZGet me the mutual friends for each of my pending incoming invites (individuals and clans).'),
        ),
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030GGet a list of friends who are playing, have played, own, or want a game'),
        ),
        _descriptor.MethodDescriptor(
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030QReturns the Steam Level of a user, the Badge level for the game, and if it\'s foil'),
        ),
        _descriptor.MethodDescriptor(
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030IGets the list of per-friend preferences this user has set for other users'),
        ),
        _descriptor.MethodDescriptor(
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030SBlocks or unblocks communication with the user.  Despite name, can be a non-friend.'),
        ),
        _descriptor.MethodDescriptor(
        ...
        _descriptor.MethodDescriptor(
            ...
            serialized_options=_b(
                '\202\265\030[Calculates and returns what to display for UI that renders new steam announcement available'),
        ),
        _descriptor.MethodDescriptor(
...
_PLAYERCLIENT = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            ...
            output_type=steammessages__unified__base__pb2._NORESPONSE,
            serialized_options=_b(
                '\202\265\030GNotification from server to client that a friend\'s nickname has changed'),
        ),
        _descriptor.MethodDescriptor(
        ...
        _descriptor.MethodDescriptor(
            ...
            output_type=steammessages__unified__base__pb2._NORESPONSE,
            serialized_options=_b(
                '\202\265\030PNotification from server to client that their community preferences have changed'),
        ),
        _descriptor.MethodDescriptor(
