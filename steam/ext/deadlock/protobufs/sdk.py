...
class ClientHello(GCProtobufMessage, msg=EMsg.GCClientHello):
...
class ConnectionStatus(GCProtobufMessage, msg=EMsg.GCClientConnectionStatus):
...
class ClientWelcome(GCProtobufMessage, msg=EMsg.GCClientWelcome):
    version: int = betterproto.uint32_field(1)
    ...
    # steam_learn_server_info: SteamLearnServerInfo = betterproto.message_field(20)
    # ^ private steam learn stuff (useless for us) but it has ridiculous amount of chaining protos
