...
class Hero(IntEnum):
    ...
    def display_name(self) -> str:
        ...
        These should match how the hero is named in the game client.
        """
    ...
    def __bool__(self) -> bool:  # type: ignore # `Hero.NONE` should be returning `False`
        return bool(self.value)

    @classproperty
    def NPC_NAMES(cls: type[Self]) -> Mapping[Hero, str]:  # type: ignore
        return {
            cls.AntiMage: "npc_dota_hero_antimage",
            cls.Axe: "npc_dota_hero_axe",
            cls.Bane: "npc_dota_hero_bane",
            cls.Bloodseeker: "npc_dota_hero_bloodseeker",
            cls.CrystalMaiden: "npc_dota_hero_crystal_maiden",
            cls.DrowRanger: "npc_dota_hero_drow_ranger",
            cls.Earthshaker: "npc_dota_hero_earthshaker",
            cls.Juggernaut: "npc_dota_hero_juggernaut",
            cls.Mirana: "npc_dota_hero_mirana",
            cls.Morphling: "npc_dota_hero_morphling",
            cls.ShadowFiend: "npc_dota_hero_nevermore",
            cls.PhantomLancer: "npc_dota_hero_phantom_lancer",
            cls.Puck: "npc_dota_hero_puck",
            cls.Pudge: "npc_dota_hero_pudge",
            cls.Razor: "npc_dota_hero_razor",
            cls.SandKing: "npc_dota_hero_sand_king",
            cls.StormSpirit: "npc_dota_hero_storm_spirit",
            cls.Sven: "npc_dota_hero_sven",
            cls.Tiny: "npc_dota_hero_tiny",
            cls.VengefulSpirit: "npc_dota_hero_vengefulspirit",
            cls.Windranger: "npc_dota_hero_windrunner",
            cls.Zeus: "npc_dota_hero_zuus",
            cls.Kunkka: "npc_dota_hero_kunkka",
            cls.Lina: "npc_dota_hero_lina",
            cls.Lion: "npc_dota_hero_lion",
            cls.ShadowShaman: "npc_dota_hero_shadow_shaman",
            cls.Slardar: "npc_dota_hero_slardar",
            cls.Tidehunter: "npc_dota_hero_tidehunter",
            cls.WitchDoctor: "npc_dota_hero_witch_doctor",
            cls.Lich: "npc_dota_hero_lich",
            cls.Riki: "npc_dota_hero_riki",
            cls.Enigma: "npc_dota_hero_enigma",
            cls.Tinker: "npc_dota_hero_tinker",
            cls.Sniper: "npc_dota_hero_sniper",
            cls.Necrophos: "npc_dota_hero_necrolyte",
            cls.Warlock: "npc_dota_hero_warlock",
            cls.Beastmaster: "npc_dota_hero_beastmaster",
            cls.QueenOfPain: "npc_dota_hero_queenofpain",
            cls.Venomancer: "npc_dota_hero_venomancer",
            cls.FacelessVoid: "npc_dota_hero_faceless_void",
            cls.WraithKing: "npc_dota_hero_skeleton_king",
            cls.DeathProphet: "npc_dota_hero_death_prophet",
            cls.PhantomAssassin: "npc_dota_hero_phantom_assassin",
            cls.Pugna: "npc_dota_hero_pugna",
            cls.TemplarAssassin: "npc_dota_hero_templar_assassin",
            cls.Viper: "npc_dota_hero_viper",
            cls.Luna: "npc_dota_hero_luna",
            cls.DragonKnight: "npc_dota_hero_dragon_knight",
            cls.Dazzle: "npc_dota_hero_dazzle",
            cls.Clockwerk: "npc_dota_hero_rattletrap",
            cls.Leshrac: "npc_dota_hero_leshrac",
            cls.NaturesProphet: "npc_dota_hero_furion",
            cls.Lifestealer: "npc_dota_hero_life_stealer",
            cls.DarkSeer: "npc_dota_hero_dark_seer",
            cls.Clinkz: "npc_dota_hero_clinkz",
            cls.Omniknight: "npc_dota_hero_omniknight",
            cls.Enchantress: "npc_dota_hero_enchantress",
            cls.Huskar: "npc_dota_hero_huskar",
            cls.NightStalker: "npc_dota_hero_night_stalker",
            cls.Broodmother: "npc_dota_hero_broodmother",
            cls.BountyHunter: "npc_dota_hero_bounty_hunter",
            cls.Weaver: "npc_dota_hero_weaver",
            cls.Jakiro: "npc_dota_hero_jakiro",
            cls.Batrider: "npc_dota_hero_batrider",
            cls.Chen: "npc_dota_hero_chen",
            cls.Spectre: "npc_dota_hero_spectre",
            cls.AncientApparition: "npc_dota_hero_ancient_apparition",
            cls.Doom: "npc_dota_hero_doom_bringer",
            cls.Ursa: "npc_dota_hero_ursa",
            cls.SpiritBreaker: "npc_dota_hero_spirit_breaker",
            cls.Gyrocopter: "npc_dota_hero_gyrocopter",
            cls.Alchemist: "npc_dota_hero_alchemist",
            cls.Invoker: "npc_dota_hero_invoker",
            cls.Silencer: "npc_dota_hero_silencer",
            cls.OutworldDestroyer: "npc_dota_hero_obsidian_destroyer",
            cls.Lycan: "npc_dota_hero_lycan",
            cls.Brewmaster: "npc_dota_hero_brewmaster",
            cls.ShadowDemon: "npc_dota_hero_shadow_demon",
            cls.LoneDruid: "npc_dota_hero_lone_druid",
            cls.ChaosKnight: "npc_dota_hero_chaos_knight",
            cls.Meepo: "npc_dota_hero_meepo",
            cls.TreantProtector: "npc_dota_hero_treant",
            cls.OgreMagi: "npc_dota_hero_ogre_magi",
            cls.Undying: "npc_dota_hero_undying",
            cls.Rubick: "npc_dota_hero_rubick",
            cls.Disruptor: "npc_dota_hero_disruptor",
            cls.NyxAssassin: "npc_dota_hero_nyx_assassin",
            cls.NagaSiren: "npc_dota_hero_naga_siren",
            cls.KeeperOfTheLight: "npc_dota_hero_keeper_of_the_light",
            cls.Io: "npc_dota_hero_wisp",
            cls.Visage: "npc_dota_hero_visage",
            cls.Slark: "npc_dota_hero_slark",
            cls.Medusa: "npc_dota_hero_medusa",
            cls.TrollWarlord: "npc_dota_hero_troll_warlord",
            cls.CentaurWarrunner: "npc_dota_hero_centaur",
            cls.Magnus: "npc_dota_hero_magnataur",
            cls.Timbersaw: "npc_dota_hero_shredder",
            cls.Bristleback: "npc_dota_hero_bristleback",
            cls.Tusk: "npc_dota_hero_tusk",
            cls.SkywrathMage: "npc_dota_hero_skywrath_mage",
            cls.Abaddon: "npc_dota_hero_abaddon",
            cls.ElderTitan: "npc_dota_hero_elder_titan",
            cls.LegionCommander: "npc_dota_hero_legion_commander",
            cls.Techies: "npc_dota_hero_techies",
            cls.EmberSpirit: "npc_dota_hero_ember_spirit",
            cls.EarthSpirit: "npc_dota_hero_earth_spirit",
            cls.Underlord: "npc_dota_hero_abyssal_underlord",
            cls.Terrorblade: "npc_dota_hero_terrorblade",
            cls.Phoenix: "npc_dota_hero_phoenix",
            cls.Oracle: "npc_dota_hero_oracle",
            cls.WinterWyvern: "npc_dota_hero_winter_wyvern",
            cls.ArcWarden: "npc_dota_hero_arc_warden",
            cls.MonkeyKing: "npc_dota_hero_monkey_king",
            cls.DarkWillow: "npc_dota_hero_dark_willow",
            cls.Pangolier: "npc_dota_hero_pangolier",
            cls.Grimstroke: "npc_dota_hero_grimstroke",
            cls.Hoodwink: "npc_dota_hero_hoodwink",
            cls.VoidSpirit: "npc_dota_hero_void_spirit",
            cls.Snapfire: "npc_dota_hero_snapfire",
            cls.Mars: "npc_dota_hero_mars",
            cls.Ringmaster: "npc_dota_hero_ringmaster",
            cls.Dawnbreaker: "npc_dota_hero_dawnbreaker",
            cls.Marci: "npc_dota_hero_marci",
            cls.PrimalBeast: "npc_dota_hero_primal_beast",
            cls.Muerta: "npc_dota_hero_muerta",
            cls.Kez: "npc_dota_hero_kez",
            cls.Largo: "npc_dota_hero_largo",
        }

    @classmethod
    def create_from_npc_dota_hero_name(cls: type[Self], value: str) -> Hero:
        return next(hero for hero, npc_name in cls.NPC_NAMES.items() if npc_name == value)

    @property
    def npc_name(self) -> str:
        """Hero NCP Name.

        These names are often used in various API, including Valve and 3rd parties.
        """
        return self.NPC_NAMES[self]

    @property
    def slug_name(self) -> str:
        """Hero Slug Name.

        Just like NPC names - these names are often used in API, including Valve and 3rd parties.
        Slug names are made by removing `"npc_dota_hero"` prefix from a hero's NPC name.
        """
        return self.NPC_NAMES[self].removeprefix("npc_dota_hero_")
